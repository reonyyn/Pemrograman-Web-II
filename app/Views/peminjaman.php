    ...
    <body>
        ...
        <div class="container">
            <div class="header-section">
                ...
                <a href="<?= base_url('peminjaman/form') ?>" class="btn-add">
                    + Tambah Peminjaman
                </a>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            foreach ($peminjaman_list as $pinjam): ?>
                                ...
                                $is_overdue =
                                    ($hari_ini > $tgl_kembali && $pinjam['status'] == 'Dipinjam');
                                ?>

                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?= esc($pinjam['nama_member']) ?></td>
                                    ...
                                    <td>
                                        ...
                                        <span class="status-badge <?= $pinjam['status'] == 'Dipinjam'
                                            ? 'status-dipinjam'
                                            : 'status-dikembalikan' ?>">
                                    ...
                                    <td>
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <?php if ($pinjam['status'] == 'Dipinjam'): ?>
                                                <a href="<?= base_url('peminjaman/kembalikan/' . $pinjam['id_peminjaman']) ?>"
                                                    class="btn-return" onclick="return confirm('Kembalikan buku?')">
                                                    Kembalikan
                                                </a>

                                            <?php endif; ?>
                                            <a href="<?= base_url('peminjaman/form/' . $pinjam['id_peminjaman']) ?>"
                                                class="btn-edit">
                                                Edit
                                            </a>
                                            <a href="<?= base_url('peminjaman/delete/' . $pinjam['id_peminjaman']) ?>"
                                                class="btn-delete" onclick="return confirm('Yakin hapus?')">
                                                Hapus
                                            </a>
                                        </div>
                                    </td>
